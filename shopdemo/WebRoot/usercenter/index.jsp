			...
			<div class="main f_r">
				...
				<div class="box clearfix">
					...
					<dl class="userinfo_box">
						<dt>
							<a class="ico"><img id="user_ico_img" src="${sessionScope.user.avatar}" width="100"
								height="100" alt="" /></a> <a
						...
						<dd>
							<table width="100%" cellpadding="0" cellspacing="0">
								<col width="350px" />
								<tr>
									<td>你的订单交易总数量：<b class="red2">2 笔</b>&nbsp;&nbsp;&nbsp;<a
										class="blue" href="usercenter/order_list.jsp">进入订单列表</a></td>
								</tr>
								<tr>
									<td>总消费额：<b class="red2">￥${sessionScope.user.totalPay}</b></td>
									
								</tr>
								<tr>
									<td>预存款余额：<b class="red2">￥${sessionScope.user.balance}</b></td>
								</tr>
							</table>
				...
				<div class="box m_10">
					<table class="list_table" width="100%" cellpadding="0"
						...
						<tr>
							<td><a href="usercenter/order_view.jsp">20140712144025249304</a></td>
							<td>2014-07-12 14:40:25</td>
							<td>张三</td>
							<td>预存款支付</td>
							<td>￥1020.00</td>
						...
						<tfoot>
							<tr>
								<td colspan="6" class="t_r"><a class="blue" href="usercenter/order_list.jsp">更多订单&gt;&gt;</a></td>
							</tr>
						</tfoot>
					</table>
				</div>
