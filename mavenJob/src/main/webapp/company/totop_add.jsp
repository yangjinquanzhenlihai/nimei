...
<title>职位置顶 - 企业推广 - 企业会员中心 - 人才系统</title>
...
当前位置：<a href="//">首页</a>&nbsp;>>&nbsp;<a href="company_index.php">会员中心</a>&nbsp;>>&nbsp;企业推广&nbsp;>>添加职位置顶
</div>
...
<div class="user_right_box">
		...
		<input name="jobsid" id="jobsid" type="hidden" value="" />
          ...
          <tr>
			...
			<input name="promotionid" type="hidden" value="3" />
