...
当前位置：<a href="">首页</a>&nbsp;>>&nbsp;<a href="company_index.php">会员中心</a>&nbsp;>>&nbsp;<a href="?act=userprofile" >账户管理</a> &nbsp;>>&nbsp;邮箱认证
</div>
			  ...
			  <div style="width:740px; background-color:#F1FBFE; border:1px #C9D9E7 solid; margin:0 auto; padding:10px; " id="sendcode">
			    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                  <tr>
                    ...
                    <td><input name="email" type="text" class="input_text_200" id="email"  value="chenyan@qq.conm"  /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
