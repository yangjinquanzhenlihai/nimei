...
<body>
	...
	<div class="reg_box">
		<div class="reg_box_tit link_lan">
			<strong>企业会员注册</strong><span>切换至 <a href="reg_user.jsp">个人会员</a>
				注册
			</span>
		</div>
					...
					<form id="Form1" name="Form1" method="post"
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td><input name="email" type="text" class="reg_input"
									id="email" maxlength="60" required="required"/> <span id="emailmsg"></span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input name="password2" type="password"
									class="reg_input" id="password2" maxlength="18" required="required"/> <span
									id="passwordmsg"></span></td>
							</tr>
							<tr>

								<td><input name="member_type" type="hidden"
									id="member_type" value="1" /></td>
