...
当前位置：<a href="//">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">会员中心</a>&nbsp;>>&nbsp;账户管理 &nbsp;>>&nbsp;消息管理
</div>
<table width="985" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:8px;" >
  <tr>
	...
	<div class="user_right_box">
		...
		<div class="us_tab">
			<a href="?act=pm&new=1" class="select">未读<span>(2)</span></a>
    ...
    <td class="us_list">
	<div >
	<strong>tanlan</strong><span style="color:#999999; padding-left:20px;">2013-08-12 14:19:31</span>
	<span style="color: #FF6600; padding-left:15px;">[新]</span>	</div>
      <div style="padding-top:4px;">	  
	  你好
	  </div>
     <div style="padding-top:4px;">
	 <a href="?act=pm_show&pmid=3&msgtype=&new=1">查看消息>></a>
	 </div>
	 </td>
    <td width="50" class="us_list"><a href="?act=pm_del&pmid=3&msgtype=&new=1" onclick="return confirm('你确定要删除吗？')">删除</a></td>
  </tr>
    <tr>
    <td width="50" align="right" class="us_list">
		<img src="//data/avatar/_no_photo.gif" border="0" />
	...
	<span style="color:#999999; padding-left:20px;">2013-08-12 09:45:49</span>
	<span style="color: #FF6600; padding-left:15px;">[新]</span>	</div>
      <div style="padding-top:4px;">	  
	  感谢您使用人才系统
...
人才系统官方网站：http://www..com
     ...
     <div style="padding-top:4px;">
	 <a href="?act=pm_show&pmid=1&msgtype=&new=1">查看消息>></a>
	 </div>
	 </td>
    <td width="50" class="us_list"><a href="?act=pm_del&pmid=1&msgtype=&new=1" onclick="return confirm('你确定要删除吗？')">删除</a></td>
  </tr>
  </table>
