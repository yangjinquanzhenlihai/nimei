...
<body>
  ...
  <tr>
    <td class="link_lan">&nbsp;&nbsp;<a href="">人才系统</a><span  style="color:#999999">&nbsp;&nbsp;(http://localhost)</span></td>
    <td   class="link_bku top_a">
	<a href="">网站首页</a> <a href="javascript:window.print();">打印简历</a>  <a href="javascript:void(0)"  class="add_resume_pool">添加到人才库</a>
  ...
  <tr>
	...
	<div class="qrcode"><img src="images/user/url_qrcode.png" alt="二维码"/></div>
	
	<h1>谭岚的个人简历</h1>
	<div class="tip">
			<span style="color: #009900">更新日期：2013-08-12</span>
			<br />
	学历：中技	&nbsp;&nbsp;工作经验：1年以下&nbsp;&nbsp;浏览：<span class="click"></span>次	</div>
    </td>
    </tr>
  <tr>
  ...
  <tr>
	...
	真实姓名：</td>
    <td bgcolor="#FFFFFF">谭岚</td>
    <td width="80" align="right" bgcolor="#FAFAFA">
	性别：</td>
    <td bgcolor="#FFFFFF">男</td>
    <td width="140" rowspan="6" align="center" bgcolor="#FFFFFF"><img src="images/user/1376273539872.jpg" width="120" height="150" /></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#FAFAFA">年龄：</td>
    <td bgcolor="#FFFFFF">33 岁</td>
  ...
  <table  border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#CCCCCC" class="resume_show">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF">442423423423423423423423423423423</td>
    </tr>
</table>
  <table  border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#CCCCCC" class="resume_show">
    <tr>
      <td colspan="2" bgcolor="#FAFAFA" class="title"><strong>教育经历</strong></td>
		  ...
		  <tr>
      <td colspan="2" bgcolor="#FAFAFA"><strong>北京 </strong>(本科)</td>
    </tr>
    <tr>
      <td width="80" align="right" bgcolor="#FAFAFA">起止年月：</td>
      <td bgcolor="#FFFFFF">2004年1月至2004年2月&nbsp;</td>
    </tr>
    <tr>
  ...
  <table  border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#CCCCCC" class="resume_show">
    <tr>
      <td colspan="2" bgcolor="#FAFAFA" class="title"><strong>工作经历</strong></td>
			 ...
			 <tr>
      <td colspan="2" bgcolor="#FAFAFA"><strong>3131</strong> - 323123</td>
    </tr>
    <tr>
      <td width="80" align="right" bgcolor="#FAFAFA">起止日期：</td>
      <td bgcolor="#FFFFFF">2006年1月至2011年2月&nbsp;</td>
    </tr>
	<tr>
      <td align="right"  bgcolor="#FAFAFA">企业名称：</td>
      <td bgcolor="#FFFFFF">3131</td>
    </tr>
	<tr>
      <td align="right" bgcolor="#FAFAFA">从事职位：</td>
      <td bgcolor="#FFFFFF">323123</td>
    </tr>
	<tr>
...
<table  border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#CCCCCC" class="resume_show resume_contact" >
    ...
    <tr>
	  ...
	  <div id="resume_contact">
	  	<div class="contact link_lan">企业会员请 <a href="users/login.jsp">登录</a>  查看联系方式！如果您不是企业会员，请先 <a href="users/register.jsp">免费注册</a> </div>
	  	<ul>
	  		<li>联 系 人：谭岚</li><li>联系电话：13652548785</li>
	  		<li>联系邮箱：tl_smile@qq.com</li><li>联系Q Q：</li>
	  		<li>联系地址：chengdu,china</li>
	  		<li>个人主页/博客：</li>
	  		</ul>
	  		<div align="center"><br>
	  		<img src="images/64.gif" border="0" id="invited">
	  		</div>
	  		<div align="center"><span class="add_resume_pool">[添加到人才库]</span>
	  		<br><br>
	  		</div>
	  </div>
	  </td>
